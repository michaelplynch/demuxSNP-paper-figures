...
load("/data/projects/demuxSNP/nextflow/ccrcc_out/demuxSNP_e/e_final_sce.rdata")
...
## update function to handle this

````{r eval=FALSE}

sce$knn[sce$knn=="multiplet"]<-"Doublet"
sce$knn_jacc[sce$knn_jacc=="multiplet"]<-"Doublet"
...
sce2<-sce[,colSums(counts(sce))>1000]
library(ComplexHeatmap)
Heatmap(counts(altExp(sce2,"SNP")),
        cluster_rows=FALSE,
        cluster_columns=TRUE,
        column_split=sce2$truth,
        column_title_rot = 45)
````
